<h1>KYC Website</h1>
    ...
    <ul>
        ...
        <li><strong>Basic Details Verification:</strong> Stores and verifies basic details like name, date of birth, address, PAN card, and Aadhaar card using APIs and various npm packages.</li>
        <li><strong>Conversational Form:</strong> Provides a conversational form interface that guides users on how to fill the form effectively.</li>
